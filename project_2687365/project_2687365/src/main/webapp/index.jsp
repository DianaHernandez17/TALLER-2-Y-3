...
<head>
    ...
    <!--Description -->
    <meta name="description" content="Esta debe ser una información que aparece en el párrafo que acompaña los resultados de una búsqueda en Internet.">
    <!--Keywords-->
    ...
    <!-- TITLE-->
    <title>Formulario Registro Al Login</title>
    <!-- FAVICON-->
    <link rel="icon" type="image/x-icon" href="./img/login.png">
    <!-- CSS-->
    <!-- bootstrap css / icons--><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css"
                                       rel="stylesheet"
